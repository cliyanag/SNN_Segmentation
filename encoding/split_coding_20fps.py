...
count_dir = os.path.join(save_path, 'count_data_20fps')
if not os.path.exists(count_dir):
  os.makedirs(count_dir)
  
gray_dir = os.path.join(save_path, 'gray_data_20fps')
...
class Events(object):
    ...
    def generate_fimage(self, input_event=0, gray=0, image_raw_event_inds_temp=0, image_raw_ts_temp=0, dt_time_temp=0, frame_rate=20):
